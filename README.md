...
The application layout is based on a tutorial from Brad Traversy's Modern Javascript course. In that course, he uses Materialize to build the UI, but I decided to build the Materialize UI from scratch in order to learn more about CSS. Also, I decided that I wanted to learn more about React hooks, so I refactored the app to use only function components and hooks to provide the state. You can view the final result at the link below. Enjoy!
